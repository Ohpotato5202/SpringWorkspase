		...
		<div class="innerOuter">
			...
			<table id="replyArea" class="table" align="center">
				<thead>
					<tr>
						<th colspan="2">
							<textarea class="form-control" name="replyContent" id="replyContent" 
							rows="2" cols="55"	style="resize: none; width: 100%;"></textarea>
						</th>
	...
	<script>
		...
		function selectReplyList(){
			$.ajax({
				...
				success : function(result){ // result == List<Reply> (jackson-databind에 의해 json형태)
		...
		function insertReply(){
			$.ajax({
				...
				success : function(result){
					if(result == 0) alertify.alert("댓글등록 실패...");
					else alertify.alert("댓글등록 성공!");
					selectReplyList();
					$("#replyContent").val("");
				}
			});
